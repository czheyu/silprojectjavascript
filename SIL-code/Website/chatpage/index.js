...
var replyingtoID;
var htmlsvguser = `<svg xmlns="http://www.w3.org/2000/svg" width="40" height="60" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
...
function getchatnamebyid(id){
  ...
  fetch(apiUrl, requestOptions)
    .then((response) => {
      ...
      chatmenutitle.innerHTML = `<strong>${data.result}</strong>`;
    });
  return;
}
...
async function setEvents(){
  ...
  userdisplay.innerHTML = "<strong>" + username + "</strong>" + htmlsvguser;
