          ...
          formated +=
            ...
            `</p></div></div>`+
              ...
              `<button style="display: none;" data-bs-id="${data.data[i].id}" data-bs-html='`+
                ...
                data.data[i].value +
                `</p></div></div>`+
            `<button data-bs-toggle="modal" data-bs-target="#confirmdelete" class="btn m-0 p-0 btn-outline-danger" type="button">delete</button><p class="text-light" style="display: flex;">${datewhennothover}</p><p class="text-light" style="display: none;">${datewhenhover}</p></div>\n`;
          ...
          formated +=
            ...
            `</p></div></div>`+
              ...
              `<button style="display: none;" data-bs-id="${data.data[i].id}" data-bs-html='`+
                ...
                data.data[i].value +
                `</p></div></div>`+
            `<button data-bs-toggle="modal" data-bs-target="#confirmdelete" class="btn m-0 p-0 btn-outline-danger" type="button">delete</button><p class="text-light" style="display: none;">${datewhenhover}</p></div>\n`;
          }
      }
    } else {
      if (previous_username != data.data[i].username){
